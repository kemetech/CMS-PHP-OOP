...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <!-- Custom styles for this template -->
    <link href="/CMS-PHP/public/assets/css/style.css" rel="stylesheet">
    <link href="/CMS-PHP/public/assets/css/dashboard.css" rel="stylesheet">
    ...
    <header class="blog-header lh-1 py-3">
      <div class="row flex-nowrap justify-content-between align-items-center">
        ...
        <div class="col-4 text-center">
          <a class="blog-header-logo text-body-emphasis" href="<?= url('/') ?>">Large</a>
        </div>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <span class="success"><?php if (!empty($messages)){
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.min.js" integrity="sha384-Y4oOpwW3duJdCWv5ly8SCFYWqFDsfob/3GkgExXKV4idmbt98QcxXYs9UoXAB7BZ" crossorigin="anonymous"></script>
  <script src="/CMS-PHP/public/assets/js/main.js"></script>
